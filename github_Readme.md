...
Whether it's architecting an e-commerce platform with dynamic pricing, configuring Nginx on AWS, or streamlining GitHub Classroom workflows for 85+ students, I love taking a project from an empty directory to a live production environment.
...
- **Project Magna AI:** Integrating custom AI models (like DeepSeek) with WhatsApp Business API for automated user engagement.
- **UBIT GitHub Classroom:** Streamlining OOP assignment submissions via automated GitHub workflows for 85+ students at the University of Karachi.
